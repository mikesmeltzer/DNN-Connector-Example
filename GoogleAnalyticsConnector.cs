...
namespace MikeSmeltzer.Connectors.ConnectorExample
{
    public class GoogleAnalyticsConnector : IConnector
    {
        ...
        private const string DefaultDisplayName = "Google Analytics Connector Example";

        public string Name
        {
            get { return "Google Analytics Connector Example"; }
        }
        ...
        {
            get { return "~/icons/sigma/GoogleAnalytics_32X32_Standard.png"; }
        }

        public string PluginFolder
        {
            get { return "~/DesktopModules/MikeSmeltzer/ConnectorExample/"; }
        }
